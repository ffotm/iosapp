...
const quranData = JSON.parse(readFileSync(join(__dirname, 'quran.json'), 'utf8'));

export function getAyah(surahId, ayahId) {
...
export function searchText(searchTerm) {
...
export function getAyahRange(surahId, startAyah, endAyah) {
...
export function getHizb(hizbNumber) {
...
export function searchBySurahName(name) {
...
export function getSurahStatistics() {
  const stats = {
